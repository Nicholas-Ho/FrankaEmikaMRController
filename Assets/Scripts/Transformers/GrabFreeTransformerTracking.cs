...
public class GrabFreeTransformerTracking : MonoBehaviour, ITransformer
{
    ...
    // For tracking
    public Vector3 startMovePosition { get; private set; }
    public Vector3 endMovePosition { get; private set; }
    public Quaternion startMoveRotation { get; private set; }
    public Quaternion endMoveRotation { get; private set; }
    ...
    public void EndTransform()
    {
        ...
        // End tracking and callback
        endMovePosition = transform.position;
        endMoveRotation = transform.rotation;
    ...
    TransformerUtils.RotationConstraints GenerateParentConstraints(TransformerUtils.RotationConstraints constraints, Quaternion initialRotation)
{
    ...
    public void AddCallbackListener(UnityAction<BaseEventData> action) { callback.AddListener(action); }
}